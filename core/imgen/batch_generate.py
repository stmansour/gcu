...
# Resolve sibling scripts relative to this file, not the caller's CWD
IMGEN_DIR = Path(__file__).parent
...
for f in files:
    ...
    subprocess.run([sys.executable, str(IMGEN_DIR / "generate_asset.py"), f], check=True)
